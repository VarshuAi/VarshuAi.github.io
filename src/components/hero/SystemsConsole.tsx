  ...
  const fragments = [
    {
      ...
      index: "SYS_01",
      name: "A1 Swaara",
      domain: "Android Music Streaming Suite",
      pipeline: ["320 kbps Stream", "Parametric EQ", "Karaoke Sync"],
      metric: "v1.0.0 Shipped",
      status: "Built",
      stack: "Flutter • Dart • Android SDK",
    ...
    },
    {
      ...
      index: "SYS_02",
      name: "FLUXA",
      domain: "Native Android Video Player",
      pipeline: ["ExoPlayer Core", "Adaptive HLS", "Multi-Audio Tracks"],
    ...
    },
    {
      ...
      index: "SYS_03",
      name: "VelorioLabs",
      domain: "Open-Source Organization",
      pipeline: ["PhishGuard-AI", "AetherEye Radar", "SubVortex"],
      metric: "43 Public Repos",
      status: "Active Org",
