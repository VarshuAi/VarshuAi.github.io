...
export function SystemsConsole() {
  ...
  return (
    <div className="w-full rounded-lg bg-[#0C0C0C] border border-[rgba(245,240,232,0.08)] shadow-[0_8px_32px_rgba(0,0,0,0.6)] overflow-hidden font-mono select-none">
      {/* HUD Header Bar */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-[rgba(245,240,232,0.08)] bg-[#101010]/90">
        ...
        <div className="flex items-center gap-3 text-[11px] text-[#68635B]">
          <span className="hidden sm:inline">KERNEL_V2.0</span>
          <span className="inline-flex items-center gap-1 text-[#9E988F]">
            ...
            <span className="text-[#C8FF00] text-[10px] uppercase tracking-wider">Live</span>
          </span>
        </div>
      </div>
      ...
      <div className="px-4 py-2.5 bg-[#090909] border-t border-[rgba(245,240,232,0.06)] flex items-center justify-between text-[10px] text-[#68635B]">
        <div className="flex items-center gap-2">
          <Cpu className="w-3 h-3 text-[#9E988F]" />
          <span>SPEC: CONCURRENT_EVENT_DRIVEN</span>
        </div>
        <div className="text-[#9E988F]">BANGALORE // UTC+5:30</div>
      </div>
    </div>
  );
}
